...
HD_PWD='/home/kobayashi/nop/PCIe_bandwidth/vivado/vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VC707_Gen2x8If128.vds -m64 -mode batch -messageDb vivado.pb -notrace -source VC707_Gen2x8If128.tcl
