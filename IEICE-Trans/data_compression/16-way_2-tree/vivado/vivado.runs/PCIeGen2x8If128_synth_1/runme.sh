...
HD_PWD='/home/kobayashi/PCIe_test/branches/IEICE/data_compression/16-way_2-tree/vivado/vivado.runs/PCIeGen2x8If128_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PCIeGen2x8If128.vds -m64 -mode batch -messageDb vivado.pb -notrace -source PCIeGen2x8If128.tcl
