...
HD_PWD='/home/kobayashi/nop/PCIe_bandwidth/vivado/vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VC707_Gen2x8If128.vdi -applog -m64 -messageDb vivado.pb -mode batch -source VC707_Gen2x8If128.tcl -notrace
